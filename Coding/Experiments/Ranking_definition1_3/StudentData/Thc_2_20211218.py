...
# 33 att in total
# 33: over time new alg
selected_attributes = all_attributes[:23]
...
output_path = r'../../../../OutputData/Ranking_definition1_3/StudentData/thc.txt'
...
output_path_outputsize = r'../../../../OutputData/Ranking_definition1_3/StudentData/thc_outputsize.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_3/StudentData/thc_time_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_3/StudentData/thc_calculations_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
