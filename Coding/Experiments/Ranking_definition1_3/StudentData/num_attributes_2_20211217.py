...
def GridSearch(original_data, all_attributes, thc, Lowerbounds, number_attributes, time_limit, only_new_alg):
...
for number_attributes in range(num_att_min, num_att_max_naive):
    ...
    for l in range(num_loops):
        t1_, calculation1_,  t2_, calculation2_, pattern_treated_unfairly_lowerbound = \
            GridSearch(original_data, all_attributes, thc, Lowerbounds, number_attributes, time_limit, only_new_alg=False)
        t1 += t1_
        t2 += t2_
...
output_path = r'../../../../OutputData/Ranking_definition1_3/StudentData/num_att.txt'
...
output_path_outputsize = r'../../../../OutputData/Ranking_definition1_3/StudentData/num_att_outputsize.txt'
...
plt.xticks([5, 10, 15, 20, 25, 30, 33])
plt.legend(loc='best')
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_3/StudentData/num_att_time_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_3/StudentData/num_att_calculations_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
