...
output_path = r'../../../../OutputData/Ranking_definition1_3/CompasData/range_k.txt'
...
for n in range(len(range_k_list)):
    ...
    for gp in pattern_treated_unfairly_lowerbound[n]:
        output_file.write("num={} {}\n".format(len(gp), gp))


output_path_outputsize = r'../../../../OutputData/Ranking_definition1_3/CompasData/range_k_outputsize.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_3/CompasData/range_k_time_global_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_3/CompasData/range_k_calculations_global_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
