...
output_path = r'../../../../OutputData/Ranking_definition1_3/CompasData/num_att.txt'
...
output_path_outputsize = r'../../../../OutputData/Ranking_definition1_3/CompasData/num_att_outputsize.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_3/CompasData/num_att_time_global_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_3/CompasData/num_att_calculations_global_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
