...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/CreditcardDataset/tha_time.png", bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/CreditcardDataset/tha_calculations.png", bbox_inches='tight')
plt.show()
plt.close()
