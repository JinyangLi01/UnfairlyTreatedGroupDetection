...
import pandas as pd
from Algorithms.DevelopingHistory import NewAlgGeneral_2_20211219 as newalg
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/MedicalDataset/tha_time.png", bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/MedicalDataset/tha_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
