...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/MedicalDataset/thc_time_att.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/MedicalDataset/thc_calculations_att.png",
            bbox_inches='tight')
plt.show()
plt.close()
