...
output_path = r'../../../../OutputData/General_0/CompasDataset/tha.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/General/CompasDataset/tha_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/General/CompasDataset/tha_calculations.png")
plt.show()
