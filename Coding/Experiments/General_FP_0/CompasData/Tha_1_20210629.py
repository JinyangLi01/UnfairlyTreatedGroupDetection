...
output_path = r'../../../../OutputData/General_1_withStopCond/CompasDataset/tha.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/CompasDataset/tha_time.png", bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/CompasDataset/tha_calculations.png", bbox_inches='tight')
plt.show()
plt.close()
