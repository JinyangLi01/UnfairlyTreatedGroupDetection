...
import pandas as pd
from Algorithms.DevelopingHistory import NewAlgGeneral_1_20210528 as newalg, NaiveAlgGeneral_1_202105258 as naivealg
...
all_attributes = ['sexC', 'ageC', 'raceC', 'MC', 'priors_count_C',
                  'c_charge_degree', 'decile_score', 'c_days_from_compas_C', 'juv_fel_count_C', 'juv_misd_count_C',
                  'juv_other_count_C', 'start_C', 'end_C',
...
for number_attributes in range(num_att_min, num_att_max):
    ...
    for l in range(num_loops):
        t1_, calculation1_,  t2_, calculation2_, result = \
            GridSearch(original_data, TP, TN, FP, FN, all_attributes, thc, number_attributes, time_limit, only_new_alg=True)
        t1 += t1_
        t2 += t2_
...
output_path = r'../../../../OutputData/General_0/CompasDataset/num_attribute_2_opt.txt'
