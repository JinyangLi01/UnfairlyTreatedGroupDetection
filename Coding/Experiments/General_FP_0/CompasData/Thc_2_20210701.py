...
output_path = r'../../../../OutputData/General_1_withStopCond/CompasDataset/thc.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/CompasDataset/thc_time.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/CompasDataset/thc_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
