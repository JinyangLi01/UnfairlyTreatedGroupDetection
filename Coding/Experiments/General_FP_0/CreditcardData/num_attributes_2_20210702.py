...
output_path = r'../../../../OutputData/General_0/CreditcardDataset/num_attribute_14att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/General/CreditcardDataset/num_att_time_14att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/General/CreditcardDataset/num_att_calculations_14att.png")
plt.show()
