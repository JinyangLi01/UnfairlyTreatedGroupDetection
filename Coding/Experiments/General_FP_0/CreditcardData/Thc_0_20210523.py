...
output_path = r'../../../../OutputData/General_0/CreditcardDataset/thc.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/General/CreditcardDataset/thc_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/General/CreditcardDataset/thc_calculations.png")
plt.show()
