...
output_path = r'../../../../OutputData/General_1_withStopCond/CreditcardDataset/data_size.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/CreditcardDataset/datasize_time.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/General_withStopCond/CreditcardDataset/datasize_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
