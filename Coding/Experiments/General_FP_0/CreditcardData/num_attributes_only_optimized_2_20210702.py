...
plt.legend()
plt.savefig("../../../../OutputData/General/CreditcardDataset/num_att_time_optimized.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/General/CreditcardDataset/num_att_calculations_optimized.png")
plt.show()
