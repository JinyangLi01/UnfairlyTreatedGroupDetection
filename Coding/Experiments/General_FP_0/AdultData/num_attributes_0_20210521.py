...
num_att_max_naive = 7 # if it's 8, naive out of time
num_att_min = 3
num_att_max = 14
...
output_path = r'../../../../OutputData/General_0/AdultDataset/num_attribute.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/General/AdultDataset/num_att_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/General/AdultDataset/num_att_calculations.png")
plt.show()
