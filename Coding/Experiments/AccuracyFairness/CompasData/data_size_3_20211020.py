...
def GridSearch(original_data_file_pathpre, datasize, thc, selected_attributes):
    ...
    pattern_with_low_accuracy3, num_calculation3, execution_time3 = naivealg_without_stop_cond.NaiveAlg(less_attribute_data,
                                                                                      mis_class_data, tha,
                                                                                      thc, time_limit)
...
output_path = r'../../../../OutputData/LowAccDetection_withStopCond/CompasDataset/data_size.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/CompasDataset/datasize_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/CompasDataset/datasize_calculations.png")
plt.show()
