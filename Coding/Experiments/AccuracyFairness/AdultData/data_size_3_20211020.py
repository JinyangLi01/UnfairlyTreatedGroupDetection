...
output_path = r'../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/data_size.txt'
...
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/datasize_time.png")
plt.show()
...
plt.legend()
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/datasize_calculations.png")
plt.show()
