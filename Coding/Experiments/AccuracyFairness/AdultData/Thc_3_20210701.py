...
output_path = r'../../../../OutputData/LowAccDetection_1_withStopCond/AdultDataset/thc.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/thc_time.png", bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/thc_calculations.png", bbox_inches='tight')
plt.show()
plt.close()
