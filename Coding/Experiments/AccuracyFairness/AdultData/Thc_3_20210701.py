...
output_path = r'../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/thc_optimized.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/thc_time_optimized.png", bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/thc_calculations_optimized.png", bbox_inches='tight')
plt.show()
plt.close()
