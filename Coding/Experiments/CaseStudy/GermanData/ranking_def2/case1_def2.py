...
from Algorithms.DevelopingHistory import NewAlgRanking_definition2_9_20220506 as newalg, \
...
print("k_max = {}, m_min = {}, alpha = {}, thc = {}".format(k_max, k_min, alpha, Thc))
...
for k in range(0, k_max - k_min):
    print("{} patterns found".format(len(result2[k])))
    for r in result2[k]:
        st = num2string(r)
        whole_cardinality = pc_whole_data.pattern_count(st)
        num_top_k = patterns_top_kmin.pattern_count(st)
