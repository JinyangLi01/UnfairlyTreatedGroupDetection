...
output_path = r'../../../../../OutputData/CaseStudy/ProPublica/fp_less_than.txt'
...
fairness_definition = 10 # FPR = FP/(FP+TN) False_positive_error_rate_balance, but for those treated too well
delta_thf = 0.05
