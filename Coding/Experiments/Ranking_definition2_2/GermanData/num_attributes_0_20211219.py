...
output_path = r'../../../../OutputData/Ranking_definition2_2/GermanData/num_att_prop_german.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_2/GermanData/num_att_time_prop_german.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_2/GermanData/num_att_calculations_prop_german.png",
            bbox_inches='tight')
plt.show()
plt.close()
