...
output_path = r'../../../../OutputData/Ranking_definition2_2/CompasData/range_k_prop_campas.txt'
...
for n in range(len(range_k_list)):
    output_file.write('{} {} \n {}\n'.format(range_k_list[n], len(patterns_found[n]), patterns_found[n]))
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_2/CompasData/range_k_time_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_2/CompasData/range_k_calculations_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
