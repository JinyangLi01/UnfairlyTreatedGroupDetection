...
output_path = r'../../../../OutputData/Ranking_definition2_2/CompasData/num_att.txt'
...
for n in range(num_att_min, num_att_max_naive):
    output_file.write('{} {} \n {}\n'.format(n, len(patterns_found[n - num_att_min]),
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_2/CompasData/num_att_time_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_2/CompasData/num_att_calculations_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
