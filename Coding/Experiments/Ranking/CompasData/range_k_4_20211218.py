...
output_path = r'../../../../OutputData/Ranking/CompasData/range_k.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking/CompasData/range_k_time.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking/CompasData/range_k_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
