...
output_path = r'../../../../OutputData/Ranking2/CompasData/thc_12att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/CompasData/thc_time_12att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/CompasData/thc_time_log_12att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/CompasData/thc_calculations_12att.png")
plt.show()
