...
output_path = r'../../../../OutputData/Ranking2/StudentData/range_k_12att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/range_k_time_12att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/range_k_calculations_12att.png")
plt.show()
