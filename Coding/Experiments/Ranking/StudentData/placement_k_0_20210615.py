...
Thc = 20
num_k = 50
k_min_list = [50, 100, 150, 200, 250, 300]
...
output_path = r'../../../../OutputData/Ranking/StudentData/placement_k.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking/StudentData/placement_k_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking/StudentData/placement_k_calculation.png")
plt.show()
