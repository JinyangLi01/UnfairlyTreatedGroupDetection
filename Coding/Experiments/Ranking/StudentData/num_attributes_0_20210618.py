...
def GridSearch(ranked_data, Thc, num_attributes, time_limit, Lowerbounds, Upperbounds,
            k_min, k_max, only_new_alg=False):
...
for number_attributes in range(num_att_min, num_att_max_naive):
    ...
    for l in range(num_loops):
        t1_, calculation1_,  t2_, calculation2_, result = \
            GridSearch(ranked_data, Thc, number_attributes, time_limit, Lowerbounds, Upperbounds,
            k_min, k_max)
        t1 += t1_
        t2 += t2_
...
output_path = r'../../../../OutputData/Ranking/StudentData/num_att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking/StudentData/num_att_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking/StudentData/num_att_calculations.png")
plt.show()
