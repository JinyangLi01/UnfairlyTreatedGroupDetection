...
output_path = r'../../../../OutputData/Ranking_definition1_2_thc200/StudentData/num_att.txt'
...
for n in range(num_att_min, num_att_max):
    output_file.write('{} {} \n {}\n'.format(n, len(patterns_found_lowerbound[n-num_att_min]),
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_2/StudentData/num_att_time_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_2/StudentData/num_att_calculations_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
