...
output_path = r'../../../../OutputData/Ranking_definition1_2_thc200/StudentData/range_k.txt'
...
for n in range(len(range_k_list)):
    output_file.write(
        'k={} {} \n {}\n'.format(range_k_list[n], len(patterns_found_lowerbound[n]), patterns_found_lowerbound[n]))
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_2/StudentData/range_k_time_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_2/StudentData/range_k_calculations_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
