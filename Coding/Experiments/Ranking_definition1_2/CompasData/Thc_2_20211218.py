...
# with 16 att, ok. 16 att in total
...
output_path = r'../../../../OutputData/Ranking_definition1_2_thc200/CompasData/thc.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_2/CompasData/thc_time_global_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_2/CompasData/thc_calculations_global_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
