...
output_path = r'../../../../OutputData/Ranking_definition1_2_thc200/GermanData/num_att_global_german.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_2/GermanData/num_att_time_global_german.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_2/GermanData/num_att_calculations_global_german.png",
            bbox_inches='tight')
plt.show()
plt.close()
