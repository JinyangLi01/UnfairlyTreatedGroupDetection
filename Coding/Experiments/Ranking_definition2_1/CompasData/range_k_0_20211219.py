...
output_path = r'../../../../OutputData/Ranking_definition2_1/CompasData/range_k_prop_campas.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_1/CompasData/range_k_time_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_1/CompasData/range_k_calculations_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
