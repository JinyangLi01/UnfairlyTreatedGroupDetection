...
output_path = r'../../../../OutputData/Ranking_definition2_1/StudentData/thc_prop_student.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_1/StudentData/thc_time_prop_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_1/StudentData/thc_calculations_prop_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
