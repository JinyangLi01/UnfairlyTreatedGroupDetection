...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_1/StudentData/num_att_time_prop_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_1/StudentData/num_att_calculations_prop_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
