...
def GridSearch(original_data_file, Thc, num_attributes, time_limit, att_to_predict, only_new_alg=False):
    ...
    if only_new_alg:
        pattern_with_low_accuracy1, num_patterns_checked1, execution_time1, OverallAccuracy, Tha, mis_class_data = \
            wholeprocess.WholeProcessWithOneAlgorithm(original_data_file, selected_attributes, Thc, time_limit, newalg.GraphTraverse, att_to_predict)
        return execution_time1, 0, num_patterns_checked1, 0
...
for number_attributes in range(num_att_min, num_att_max_naive):
    ...
    t1, t2, n1, n2 = GridSearch(original_data_file, Thc, number_attributes, time_limit, att_to_predict)
...
for number_attributes in range(num_att_max_naive, num_att_max):
    print("number of attributes = {}".format(number_attributes))
    t1, t2, n1, n2 = GridSearch(original_data_file, Thc, number_attributes, time_limit, att_to_predict, True)
    execution_time1.append(t1)
    num_patterns_checked1.append(n1)
...
output_path = r'../../../OutputData/RecidivismDataset/num_attribute.txt'
