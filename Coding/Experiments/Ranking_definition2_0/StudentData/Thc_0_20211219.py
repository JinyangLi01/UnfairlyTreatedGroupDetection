...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2/StudentData/thc_time_15att.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2/StudentData/thc_calculations_15att.png",
            bbox_inches='tight')
plt.show()
plt.close()
