...
output_path = r'../../../../OutputData/Ranking_definition2_1/StudentData/data_size.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_1/StudentData/datasize_time.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_1/StudentData/datasize_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
