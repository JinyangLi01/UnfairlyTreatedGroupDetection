...
output_path = r'../../../../OutputData/General_2/CreditcardDataset/thcNaiveTime.txt'
...
# plt.grid(True)
# fig.tight_layout()
# plt.savefig("../../../../OutputData/General_2/CreditcardDataset/thc_time.png",
#             bbox_inches='tight')
# plt.show()
# plt.close()
#
...
# plt.grid(True)
# fig.tight_layout()
# plt.savefig("../../../../OutputData/General_2/CreditcardDataset/thc_calculations.png",
#             bbox_inches='tight')
# plt.show()
# plt.close()
#
