...
output_path = r'../../../../OutputData/CreditcardDataset/thc.txt'
...
plt.xscale("log")
plt.legend()
plt.savefig("../../../OutputData/CreditcardDataset/thc_time.png")
plt.show()
...
plt.xscale("log")
plt.legend()
plt.savefig("../../../OutputData/CreditcardDataset/thc_calculations.png")
plt.show()
