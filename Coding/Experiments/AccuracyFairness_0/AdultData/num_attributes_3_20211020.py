...
output_path = r'../../../../OutputData/LowAccDetection_1_withStopCond/AdultDataset/num_attribute.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/num_att_time.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/AdultDataset/num_att_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
