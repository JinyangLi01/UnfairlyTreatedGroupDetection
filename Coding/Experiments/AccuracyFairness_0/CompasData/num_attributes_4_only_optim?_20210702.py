...
import pandas as pd
from Algorithms.DevelopingHistory import NaiveAlg_1_20210528 as naivealg, NewAlg_1_20210529 as newalg
...
output_path = r'../../../../OutputData/LowAccDetection_0/CompasDataset/num_attribute_18att_opt_only.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/CompasDataset/num_att_time_18att_opt_only.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/CompasDataset/num_att_calculations_18att_opt_only.png")
plt.show()
