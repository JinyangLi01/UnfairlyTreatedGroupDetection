...
for thc in Thc_list:
    ...
    for l in range(num_loops):
        ...
        pattern_with_low_accuracy2, calculation2_, t2_ = naivealg.NaiveAlg(less_attribute_data,
                                                                              mis_class_data, tha,
                                                                              thc, time_limit)
        print("time = {} s, num_calculation = {}".format(t2_, calculation2_))
...
output_path = r'../../../../OutputData/LowAccDetection_0/CompasDataset/thc.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/CompasDataset/thc_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/CompasDataset/thc_calculations.png")
plt.show()
