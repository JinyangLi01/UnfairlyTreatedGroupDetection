...
output_path = r'../../../../OutputData/LowAccDetection_0/CompasDataset/num_attribute_18att.txt'
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/CompasDataset/num_att_calculations_18att.png")
plt.show()
