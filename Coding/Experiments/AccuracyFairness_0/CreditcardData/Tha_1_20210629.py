...
for dif in diff_acc:
    ...
    for l in range(num_loops):
        ...
        pattern_with_low_accuracy, sizes_of_patterns, fairness_values_of_patterns, num_calculation, t_ \
...
output_path = r'../../../../OutputData/LowAccDetection_1_withStopCond/CreditcardDataset/tha.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/CreditcardDataset/tha_time.png", bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/CreditcardDataset/tha_calculations.png", bbox_inches='tight')
plt.show()
plt.close()
