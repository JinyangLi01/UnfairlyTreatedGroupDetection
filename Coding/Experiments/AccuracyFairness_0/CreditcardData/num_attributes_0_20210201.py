...
output_path = r'../../../../OutputData/LowAccDetection_0/CreditcardDataset/num_attribute.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/CreditcardDataset/num_att_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/CreditcardDataset/num_att_calculations.png")
plt.show()
