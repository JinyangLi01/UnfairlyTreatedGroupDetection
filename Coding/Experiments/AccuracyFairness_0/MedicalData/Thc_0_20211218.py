...
output_path = r'../../../../OutputData/LowAccDetection_1_withStopCond/MedicalDataset/thc_14att.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/MedicalDataset/thc_time_14att.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/MedicalDataset/thc_calculations_14att.png",
            bbox_inches='tight')
plt.show()
plt.close()
