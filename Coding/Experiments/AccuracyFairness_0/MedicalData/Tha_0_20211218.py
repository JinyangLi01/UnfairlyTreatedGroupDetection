...
all_attributes = ['AGE_C', 'RACE', 'K6SUM42_C',
                  ...
                  'INSCOV']
# 13 att is ok
# with 14 att, dif_acc = 0.05, new alg needs 149 s
# with 16 att, dif = 0.05, new alg needs 573 s
...
output_path = r'../../../../OutputData/LowAccDetection_1_withStopCond/MedicalDataset/tha.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/MedicalDataset/tha_time.png", bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/MedicalDataset/tha_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
