...
output_path = r'../../../../OutputData/LowAccDetection_1_withStopCond/MedicalDataset/data_size_8att.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/MedicalDataset/datasize_time_8att.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_withStopCond/MedicalDataset/datasize_calculations_8att.png",
            bbox_inches='tight')
plt.show()
plt.close()
