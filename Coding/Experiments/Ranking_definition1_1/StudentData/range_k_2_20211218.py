...
output_path = r'../../../../OutputData/Ranking_definition1_1_thc50/StudentData/range_k.txt'
...
output_path_outputsize = r'../../../../OutputData/Ranking_definition1_1_thc50/StudentData/range_k_outputsize.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_1/StudentData/range_k_time_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition1_1/StudentData/range_k_calculations_global_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
