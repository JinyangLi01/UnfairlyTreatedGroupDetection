...
output_path = r'../../../../OutputData/Ranking_definition1_0/StudentData/data_size_11att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/datasize_time_11att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/datasize_calculations_11att.png")
plt.show()
