...
import pandas as pd
from Algorithms.DevelopingHistory import NewAlgRanking_5_20210624 as newalg, NaiveAlgRanking_1_20210611 as naivealg
...
#                   'school_C', 'sex_C', 'age_C', 'address_C', 'famsize_C', 'Pstatus_C', 'Medu_C',
...
num_att_max_naive = 20 # if it's ??, naive out of time
num_att_min = 3
num_att_max = 32
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/num_att_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/num_att_calculations.png")
plt.show()
