...
def GridSearch(original_data_file_pathpre, datasize, Thc, selected_attributes, Lowerbounds,
...
for datasize in data_sizes:
    ...
    for l in range(num_loops):
        t1_, num_patterns_visited1_, t2_, num_patterns_visited2_, pattern_treated_unfairly_lowerbound = \
            GridSearch(original_data_file_pathprefix, datasize, Thc, selected_attributes, Lowerbounds,
        k_min, k_max, time_limit)
        t1 += t1_
        t2 += t2_
...
output_path = r'../../../../OutputData/Ranking_definition1_0/StudentData/data_size_16att.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking/StudentData/datasize_time_16att.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking/StudentData/datasize_calculations_16att.png",
            bbox_inches='tight')
plt.show()
plt.close()
