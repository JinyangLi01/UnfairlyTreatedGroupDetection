...
output_path = r'../../../../OutputData/Ranking_definition1_0/StudentData/thc.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking/StudentData/thc_time.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking/StudentData/thc_calculations.png")
plt.show()
