...
output_path = r'../../../../OutputData/Ranking_definition1_0/StudentData/thc_14att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/thc_time_14att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/thc_time_log_14att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/thc_calculations_14att.png")
plt.show()
