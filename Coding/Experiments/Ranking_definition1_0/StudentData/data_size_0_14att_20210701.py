...
output_path = r'../../../../OutputData/Ranking_definition1_0/StudentData/data_size_14att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/datasize_time_14att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/datasize_calculations_14att.png")
plt.show()
