...
output_path = r'../../../../OutputData/Ranking_definition1_0/StudentData/thc_11att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/thc_time_11att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/thc_time_log_11att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/thc_calculations_11att.png")
plt.show()
