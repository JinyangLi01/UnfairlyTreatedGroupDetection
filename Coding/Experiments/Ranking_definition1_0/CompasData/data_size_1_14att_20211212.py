...
output_path = r'../../../../OutputData/Ranking_definition1_0/CompasData/data_size_14att.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking/CompasData/datasize_time_14att.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking/CompasData/datasize_calculations_14att.png",
            bbox_inches='tight')
plt.show()
plt.close()
