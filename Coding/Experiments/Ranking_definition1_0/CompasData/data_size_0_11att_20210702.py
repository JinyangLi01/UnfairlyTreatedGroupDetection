...
data_sizes = [7000, 8000, 9000, 10000, 11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000]
...
output_path = r'../../../../OutputData/Ranking_definition1_0/CompasData/data_size_11att.txt'
...
plt.xticks([7000, 8000, 10000, 12000, 14000, 16000, 18000])
ax.xaxis.set_major_formatter(FuncFormatter(thousands_formatter))
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/CompasData/datasize_time_11att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/CompasData/datasize_calculations_11att.png")
plt.show()
