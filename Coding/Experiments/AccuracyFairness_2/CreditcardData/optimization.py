...
# with 8 att, naive needs 420 s
num_att_max_naive = 8 # naive out of time when set to 10
num_att_min = 7
num_att_max = 8
...
output_path = r'../../../../OutputData/LowAccDetection_1_withStopCond/CreditcardDataset/optimization.txt'
