...
output_path = r'../../../../OutputData/LowAccDetection_2/MedicalDataset/tha.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_2/MedicalDataset/tha_time.png", bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/LowAccDetection_2/MedicalDataset/tha_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
