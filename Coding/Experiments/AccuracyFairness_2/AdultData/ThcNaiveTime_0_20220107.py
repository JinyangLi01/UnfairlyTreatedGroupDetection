...
import pandas as pd
from Algorithms.DevelopingHistory import NaiveAlg_2_20211020 as naivealg, NewAlg_2_20211001 as newalg
...
output_path = r'../../../../OutputData/LowAccDetection_2/AdultDataset/thcNaiveTime.txt'
...
# plt.grid(True)
# fig.tight_layout()
# plt.savefig("../../../../OutputData/LowAccDetection_2/AdultDataset/thc_time.png", bbox_inches='tight')
# plt.show()
# plt.close()
#
#
...
# plt.grid(True)
# fig.tight_layout()
# plt.savefig("../../../../OutputData/LowAccDetection_2/AdultDataset/thc_calculations.png", bbox_inches='tight')
# plt.show()
# plt.close()
#
#
