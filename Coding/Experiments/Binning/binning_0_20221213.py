...
selected_attributes = all_attributes[:13] + ['absences_C']
...
output_path = r'../../../OutputData/Binning/StudentData/binning_prop_student.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../OutputData/Binning/StudentData/binning_time_prop_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../OutputData/Binning/StudentData/binning_calculations_prop_student.png",
            bbox_inches='tight')
plt.show()
plt.close()
