...
output_path = r'../../../../OutputData/Ranking2/StudentData/range_k_13att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/range_k_time_13att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/StudentData/range_k_calculations_13att.png")
plt.show()
