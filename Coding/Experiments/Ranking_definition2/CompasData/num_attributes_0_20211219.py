...
output_path = r'../../../../OutputData/Ranking_definition2_0/CompasData/num_att.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2/CompasData/num_att_time.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2/CompasData/num_att_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
