...
output_path = r'../../../../OutputData/Ranking2/CompasData/thc_15att.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/CompasData/thc_time_15att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/CompasData/thc_time_log_15att.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/Ranking2/CompasData/thc_calculations_15att.png")
plt.show()
