...
output_path = r'../../../../OutputData/Ranking_definition2_3/CompasData/range_k_prop_campas.txt'
...
for n in range(len(range_k_list)):
    ...
    for gp in patterns_found[n]:
        output_file.write("num={} {}\n".format(len(gp), gp))


output_path_outputsize = r'../../../../OutputData/Ranking_definition2_3/CompasData/range_k_outputsize.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_3/CompasData/range_k_time_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_3/CompasData/range_k_calculations_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
