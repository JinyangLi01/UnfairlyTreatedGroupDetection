import pandas as pd
from Algorithms.DevelopingHistory import NewAlgRanking_definition2_15 as newalg, \
...
output_path = r'../../../../OutputData/Ranking_definition2_3/CompasData/num_att.txt'
...
for n in range(num_att_min, num_att_max):
    ...
    for gp in patterns_found[n - num_att_min]:
        output_file.write("num={} {}\n".format(len(gp), gp))


output_path_outputsize = r'../../../../OutputData/Ranking_definition2_3/CompasData/num_att_outputsize.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_3/CompasData/num_att_time_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_3/CompasData/num_att_calculations_prop_compas.png",
            bbox_inches='tight')
plt.show()
plt.close()
