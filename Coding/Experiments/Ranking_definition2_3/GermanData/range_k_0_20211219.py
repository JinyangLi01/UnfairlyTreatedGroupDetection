...
output_path = r'../../../../OutputData/Ranking_definition2_3/GermanData/range_k_prop_german.txt'
...
output_path_outputsize = r'../../../../OutputData/Ranking_definition2_3/GermanData/range_k_outputsize.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_3/GermanData/range_k_time_prop_german.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_3/GermanData/range_k_calculations_prop_german.png",
            bbox_inches='tight')
plt.show()
plt.close()
