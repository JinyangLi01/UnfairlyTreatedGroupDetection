...
output_path = r'../../../../OutputData/Ranking_definition2_3/GermanData/thc.txt'
...
output_path_outputsize = r'../../../../OutputData/Ranking_definition2_3/GermanData/thc_outputsize.txt'
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_3/GermanData/thc_time_upr_german.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("../../../../OutputData/Ranking_definition2_3/GermanData/thc_calculations_upr_german.png",
            bbox_inches='tight')
plt.show()
plt.close()
