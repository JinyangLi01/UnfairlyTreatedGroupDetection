...
This script is different form NewAlgRanking_definition2_3.py that:
...
This method is a little slower, so I should still maintain patterns_size_whole
"""
