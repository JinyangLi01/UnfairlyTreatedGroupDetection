...
input_path = [r"../../LowAccDetection_2/AdultDataset/thc.txt",
              r"../../LowAccDetection_2/CompasDataset/thc.txt",
              r"../../LowAccDetection_2/CreditcardDataset/thc.txt",
              r"../../LowAccDetection_2/MedicalDataset/thc.txt",
              r"../../General_2/AdultDataset/thc.txt",
              r"../../General_2/CompasDataset/thc.txt",
              r"../../General_2/CreditcardDataset/thc.txt",
              r"../../General_2/MedicalDataset/thc.txt"]
...
plt.grid(True)
fig.tight_layout()
plt.savefig("thc_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
