...
# plt_title = ["BlueNile", "Medical", "Credit Card"]
...
input_path = [r"../../LowAccDetection_2/MedicalDataset/num_att.txt",
              r"../../General_2/MedicalDataset/num_att.txt"]
...
plt.grid(True)
fig.tight_layout()
plt.savefig("num_att_Medical_time.png",
            bbox_inches='tight')
plt.show()
plt.close()
...
plt.grid(True)
fig.tight_layout()
plt.savefig("num_att_Medical_calculations.png",
            bbox_inches='tight')
plt.show()
plt.close()
