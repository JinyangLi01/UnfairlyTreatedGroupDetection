...
input_path = r'num_k_11att_num_patterns.txt'
...
for line in Lines:
    ...
    num_patterns1.append(float(items[1]))
    num_patterns2.append(float(items[2]))
...
plt.plot(krange_list[:5], num_patterns2[:5], label="naive algorithm", color='orange', linewidth = 3.4)
...
plt.legend()
plt.savefig("range_k11att_patterns_naive_240.png")
plt.show()
