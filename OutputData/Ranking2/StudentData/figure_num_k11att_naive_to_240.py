...
input_path = r'range_k_11att.txt'
...
plt.plot(krange_list[:5], execution_time2[:5], label="naive algorithm", color='orange', linewidth = 3.4)
...
plt.legend()
plt.savefig("range_k11att_time_naive_240.png")
plt.show()
